...
{
    /// <summary>
    /// Default UI Enum Switcher. Intended for use with the AutoUI system.
    /// </summary>
    public class MDefaultUiEnumSwitcherElement : MUiEnumSwitcherElement
    {
        private readonly SpriteMap _box = new SpriteMap(Mod.GetPath<MModClass>("Ui/UiElementBox"), 8, 8);

        /// <inheritdoc />
        public MDefaultUiEnumSwitcherElement(Vec2 pos, FieldInfo field) : base(pos, new Vec2(16f), field, 2f)
        {
